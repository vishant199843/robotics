...
class Metaclass_FollowPath_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bicycle_control_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_Goal')
            logger.debug(
...
class Metaclass_FollowPath_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FollowPath_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FollowPath_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bicycle_control_interfaces.action import FollowPath
...
class FollowPath_SendGoal_Request(metaclass=Metaclass_FollowPath_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'bicycle_control_interfaces/FollowPath_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from bicycle_control_interfaces.action._follow_path import FollowPath_Goal
...
class FollowPath_SendGoal_Event(metaclass=Metaclass_FollowPath_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<bicycle_control_interfaces/FollowPath_SendGoal_Request, 1>',
        'response': 'sequence<bicycle_control_interfaces/FollowPath_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from bicycle_control_interfaces.action import FollowPath_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from bicycle_control_interfaces.action import FollowPath_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_FollowPath_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from bicycle_control_interfaces.action import _follow_path
...
class FollowPath_SendGoal(metaclass=Metaclass_FollowPath_SendGoal):
    from bicycle_control_interfaces.action._follow_path import FollowPath_SendGoal_Request as Request
    from bicycle_control_interfaces.action._follow_path import FollowPath_SendGoal_Response as Response
    from bicycle_control_interfaces.action._follow_path import FollowPath_SendGoal_Event as Event
...
class FollowPath_GetResult_Response(metaclass=Metaclass_FollowPath_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'bicycle_control_interfaces/FollowPath_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from bicycle_control_interfaces.action._follow_path import FollowPath_Result
...
class FollowPath_GetResult_Event(metaclass=Metaclass_FollowPath_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<bicycle_control_interfaces/FollowPath_GetResult_Request, 1>',
        'response': 'sequence<bicycle_control_interfaces/FollowPath_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from bicycle_control_interfaces.action import FollowPath_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from bicycle_control_interfaces.action import FollowPath_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_FollowPath_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_GetResult(metaclass=Metaclass_FollowPath_GetResult):
    from bicycle_control_interfaces.action._follow_path import FollowPath_GetResult_Request as Request
    from bicycle_control_interfaces.action._follow_path import FollowPath_GetResult_Response as Response
    from bicycle_control_interfaces.action._follow_path import FollowPath_GetResult_Event as Event
...
class Metaclass_FollowPath_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_FeedbackMessage(metaclass=Metaclass_FollowPath_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'bicycle_control_interfaces/FollowPath_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['bicycle_control_interfaces', 'action'], 'FollowPath_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from bicycle_control_interfaces.action._follow_path import FollowPath_Feedback
...
class Metaclass_FollowPath(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bicycle_control_interfaces.action.FollowPath')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath(metaclass=Metaclass_FollowPath):
    ...
    from bicycle_control_interfaces.action._follow_path import FollowPath_Goal as Goal
    # The result message defined in the action definition.
    from bicycle_control_interfaces.action._follow_path import FollowPath_Result as Result
    # The feedback message defined in the action definition.
    from bicycle_control_interfaces.action._follow_path import FollowPath_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from bicycle_control_interfaces.action._follow_path import FollowPath_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from bicycle_control_interfaces.action._follow_path import FollowPath_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from bicycle_control_interfaces.action._follow_path import FollowPath_FeedbackMessage as FeedbackMessage
